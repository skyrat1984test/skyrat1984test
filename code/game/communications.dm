...
GLOBAL_LIST_INIT(default_radio_channels, list(
	...
	RADIO_CHANNEL_BITRUN = FREQ_BITRUN, //Celadon ADDITION - BITRUN
	RADIO_CHANNEL_BITDEFEND = FREQ_BITDEFEND, //Celadon ADDITION - BITRUN
...
GLOBAL_LIST_INIT(reserved_radio_frequencies, list(
	...
	"[FREQ_BITRUN]" = RADIO_CHANNEL_BITRUN, //Celadon ADDITION - BITRUN
	"[FREQ_BITDEFEND]" = RADIO_CHANNEL_BITDEFEND, //Celadon ADDITION - BITRUN
...
GLOBAL_LIST_INIT(reserved_radio_colors, list(
	...
	RADIO_CHANNEL_BITRUN = "#d1ba22",
	RADIO_CHANNEL_BITDEFEND = "#ff0000",
))
