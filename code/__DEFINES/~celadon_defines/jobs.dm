...
//job flags
#define CENTCOM_JOB_FLAGS (JOB_NEW_PLAYER_JOINABLE|JOB_REOPEN_ON_ROUNDSTART_LOSS|JOB_EQUIP_RANK|JOB_ASSIGN_QUIRKS|JOB_CAN_BE_INTERN|JOB_BOLD_SELECT_TEXT|JOB_CANNOT_OPEN_SLOTS|JOB_HEAD_OF_STAFF|JOB_ANTAG_PROTECTED|JOB_ANTAG_BLACKLISTED|JOB_LATEJOIN_ONLY|JOB_HIDE_WHEN_EMPTY)

//jobs
///centcom
#define JOB_CENTCOM_CAPTAIN "CentCom Captain"
